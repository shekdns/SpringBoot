...
public class OrderDetailSample extends StudyApplicationTests {
    ...
    private void item(User user){
        ...
        OrderTypeStatus type = OrderTypeStatus.ALL;
        ...
        for(Item item : items){
            ...
            OrderDetail orderDetail = OrderDetail.builder()
                    ...
                    .item(item)
                    .arrivalDate(type.equals(type) ? orderGroup.getArrivalDate() : getRandomDate())
                    .status(type.equals(type) ? status :orderDetailStatus)
                    .build();
